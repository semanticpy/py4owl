...
Ready to contribute? Here's how to set up `py4owl` for local development.

#. Clone the `py4owl` repo from GitLab::

    $ git clone git@gitlab.com:opensourcelab/py4owl.git
...
#. Add the release tag (version) on GitLab: https://gitlab.com/opensourcelab/py4owl/-/tags
